...
describe('PermissionDatabase', () => {
  test('should pass', async () => {
    const db = await PermissionDatabase;
    expect((await db.list()).length).toBe(50);
  });
});
...
describe('AssetDatabase', () => {
  test('should pass', async () => {
    ...
    expect((await db.list()).length).toBe(30);
  });
});
...
describe('ArtifactDatabase', () => {
  test('should pass', async () => {
    ...
    expect((await db.list()).length).toBe(500);
  });
});
...
describe('ProjectDatabase', () => {
  test('should pass', async () => {
    ...
    expect((await db.list()).length).toBe(20);
  });
});

describe('CriterionDatabase', () => {
  test('should pass', async () => {
    const db = await CriterionDatabase;
    expect((await db.list()).length).toBe(100);
  });
});
